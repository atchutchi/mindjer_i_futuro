...
const ProjectoCard = ({ titulo, slug, categoria, imagemUrl, index }: ProjectoCardProps) => {
  ...
  return (
    <Link
      ...
      className="group relative block aspect-[4/3] overflow-hidden bg-[var(--color-creme-escuro)] shadow-[var(--shadow-borgonha)] perspective-[1000px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--color-ouro)] md:cursor-none"
